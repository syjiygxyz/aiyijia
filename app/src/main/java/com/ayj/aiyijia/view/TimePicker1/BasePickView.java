...
public class BasePickView {
            ...
            public void onAnimationEnd(Animation animation)
            {
                decorView.post(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        {
                            onDismissListener.onDismiss(BasePickView.this);
                        }
                    }
                });
            }
     ...
     * @return
     */
    public BasePickView setOnDismissListener(OnDismissListener onDismissListener)
    {
        this.onDismissListener = onDismissListener;
        return this;
    }

    public BasePickView setCancelable(boolean isCancelable)
    {
