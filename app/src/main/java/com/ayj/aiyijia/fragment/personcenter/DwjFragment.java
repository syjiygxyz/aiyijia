 ...
 */
public class DwjFragment extends LazyFragment {
    ...
    /*跳转参数*/
    public static DwjFragment newInstance(String type, String param1) {
        DwjFragment fragment = new DwjFragment();
                                ...
                                case 0:
                                    ...
                                    if (null == dsjAdapter) {
                                        dsjAdapter = new DsjAdapter(
                                                R.layout.dwj_list_item, list,status);
