 ...
 */
package com.ayj.aiyijia.adapter.base;
...
import com.ayj.aiyijia.adapter.base.animation.AlphaInAnimation;
import com.ayj.aiyijia.adapter.base.animation.BaseAnimation;
import com.ayj.aiyijia.adapter.base.animation.ScaleInAnimation;
import com.ayj.aiyijia.adapter.base.animation.SlideInBottomAnimation;
import com.ayj.aiyijia.adapter.base.animation.SlideInLeftAnimation;
import com.ayj.aiyijia.adapter.base.animation.SlideInRightAnimation;
import com.ayj.aiyijia.adapter.base.entity.IExpandable;
import com.ayj.aiyijia.adapter.base.loadmore.LoadMoreView;
import com.ayj.aiyijia.adapter.base.loadmore.SimpleLoadMoreView;
        ...
        switch (viewType) {
            case 0:
                ...
                if (getHeaderLayout() != null && getHeaderLayout().getChildCount() > 0) {
                    convert(holder, mData.get(positions - 1));
                } else {
